...
if (cluster.isMaster) {
    ...
    console.log(`Attack Lauched @DilzXI`);
    ...
    if (debugMode) {
        setInterval(() => {
            ...
            const statusString = Object.entries(statuses)
                ...
                .join(', ');
            console.clear();
            console.log(`[JSBYPASS/BixD] | Date: [${new Date().toLocaleString('en-US')}] | Status: [${statusString}] | ProxyConnect: [${totalConnections}]`);
            proxyConnections = 0;
        }, 1000);
    }
